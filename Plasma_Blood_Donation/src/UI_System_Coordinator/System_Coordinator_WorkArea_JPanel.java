...
public class System_Coordinator_WorkArea_JPanel extends javax.swing.JPanel {

    //Creates new form System_Coordinator_WorkArea
    ...
    private Donor_Dir donor_dir;
    private Network_Cities network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();

    public System_Coordinator_WorkArea_JPanel(User_Acc account, System_Coordinator_Association systorganization, Enterprise enterprise, EcoSystem business, Network_Cities network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnDonorList.setFont(new java.awt.Font("Cambria", 1, 12)); // NOI18N
        ...
        BtnDonorList.setText("DONOR LIST");
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                ...
                .addComponent(BtnDonorList, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(BtnDonorList, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        BtnPatientsList.setFont(new java.awt.Font("Cambria", 1, 12)); // NOI18N
        ...
        BtnPatientsList.setText("PATIENTS LIST");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(BtnPatientsList, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addComponent(BtnPatientsList, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        BtnManageDonorRequests.setBackground(new java.awt.Color(102, 0, 102));
        BtnManageDonorRequests.setFont(new java.awt.Font("Cambria", 1, 12)); // NOI18N
        ...
        BtnManageDonorRequests.setText("DONOR REQUEST MANAGEMENT");
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                .addComponent(BtnManageDonorRequests, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        BtnManagePatientRequests.setFont(new java.awt.Font("Cambria", 1, 12)); // NOI18N
        ...
        BtnManagePatientRequests.setText("PATIENT REQUEST MANAGEMENT");
        ...
        BtnManagePatientRequests.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                patient_request_management(evt);
            }
        });
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                ...
                .addComponent(BtnManagePatientRequests)
                .addContainerGap())
        ...
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(BtnProfile, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel14.setForeground(new java.awt.Color(102, 0, 102));
        ...
        jPanel3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 82, 220, 10));
        jPanel3.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, -1, -1));
        jPanel3.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 220, -1));
        jPanel3.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 392, -1, 20));
        jPanel3.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, 220, -1));
    ...
    // VIEW ALL THE AVAILABLE DONORS LIST
    private void donor_list(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_donor_list
        Donor_List_JPanel donor_list = new Donor_List_JPanel(userAccount, system, network);
        userProcessContainer.add("DonorListJPanel", donor_list);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_donor_list

    //VIEW ALL THE PATIENT DETAILS
    private void patient_list(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_patient_list
        Patient_List_JPanel patient_List = new Patient_List_JPanel(userAccount, system, network, sys_coordinator_association);
        userProcessContainer.add("PatientListJPanel", patient_List);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_patient_list

    private void donor_request_management(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_donor_request_management
    }//GEN-LAST:event_donor_request_management
    private void patient_request_management(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_patient_request_management
    }//GEN-LAST:event_patient_request_management

    //VIEW THE SYSTEM CO-ORDINATORS PROFILE
    private void view_profile(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_view_profile

        Manage_System_Coordinator_Profile sys_coordinator = new Manage_System_Coordinator_Profile(userAccount, sys_coordinator_association, enterprise);
        userProcessContainer.add("ManageSystemCoordinatorProfile", sys_coordinator);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
