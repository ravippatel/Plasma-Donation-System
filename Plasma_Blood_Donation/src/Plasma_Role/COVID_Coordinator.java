...
import UI_COVID_Coordinator.COVID_Coordinator_JPanel;
/**
 *
 * @author RST
 */
public class COVID_Coordinator extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, User_Acc acc, Association association, Enterprise ent, EcoSystem business, Network_Cities n) {
        return new COVID_Coordinator_JPanel(acc, (COVID_Association) association, ent, business, n);
    }
