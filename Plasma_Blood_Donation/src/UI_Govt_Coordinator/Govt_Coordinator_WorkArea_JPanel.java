 ...
 * @author RST
 */
public class Govt_Coordinator_WorkArea_JPanel extends javax.swing.JPanel {

    //Creates new form Govt_Coordinator_WorkArea
    
    private User_Acc userAccount;
    private Government_Association govt;
    boolean a = true;
    ...
    public Govt_Coordinator_WorkArea_JPanel(User_Acc account, Government_Association govtorganization, Enterprise enterprise, EcoSystem business, Network_Cities network) {
        initComponents();
        this.system = system;
        this.userAccount = account;
        this.govt = govtorganization;
        this.e = enterprise;
    ...
    private void initComponents() {
        ...
        menuhide.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 220, 50));
        ...
        BtnDonorRequests.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        BtnDonorRequests.setText("MONITOR DONOR REQUEST");
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                ...
                .addComponent(BtnDonorRequests, javax.swing.GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        BtnSelfProfile.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        BtnSelfProfile.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                edit_self_profile(evt);
            }
        });

        BtnDonorStatus.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                .addGap(61, 61, 61)
                .addComponent(BtnSelfProfile, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jSeparator3, javax.swing.GroupLayout.DEFAULT_SIZE, 17, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BtnDonorStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .addComponent(jSeparator4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
        );
        ...
        menuhide.add(jPanel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 220, 30));

        BtnCuredPatients.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        BtnCuredPatients.setText("COMMUNICATE CURED PATIENT");
        ...
        BtnCuredPatients.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                communicate_cured(evt);
            }
        });
        menuhide.add(BtnCuredPatients, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 216, 30));

        BtnCreateDonor.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        BtnCreateDonor.setText("DONOR CREATION");
        ...
        menuhide.add(BtnCreateDonor, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 210, 50));
        ...
        menuhide.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 480, 75, 51));
        menuhide.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 452, 200, 0));
        menuhide.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 450, 220, -1));
        menuhide.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 210, 10));
    ...
    //CONNECT TO ALL THE CURED PATIENTS
    private void communicate_cured(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_communicate_cured
        // TODO add your handling code here:
        Encourage_Cured_Patients_JPanel c = new Encourage_Cured_Patients_JPanel();
        userProcessContainer.add("CheckOldPatientsJPanel", c);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_communicate_cured

    //EDIT PROFILE
    private void edit_self_profile(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edit_self_profile
        // TODO add your handling code here:
        Manage_Govt_Coordinator_Profile govt_profile = new Manage_Govt_Coordinator_Profile(userAccount, govt, e);
        userProcessContainer.add("ManageGovernmentCoordinatorProfile", govt_profile);
        CardLayout card = (CardLayout) userProcessContainer.getLayout();
        card.next(userProcessContainer);
    }//GEN-LAST:event_edit_self_profile

    private void BtnCreateDonorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnCreateDonorMouseClicked
        // TODO add your handling code here:
        Create_Donor_JPanel Profile = null;
        try {
            Profile = new Create_Donor_JPanel(system);
        } catch (GeneralSecurityException ex) {
            Logger.getLogger(Govt_Coordinator_WorkArea_JPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    //check current donor status
    
    private void check_donor_status(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_check_donor_status
        // TODO add your handling code here;
        Donor_Status_JPanel p = new Donor_Status_JPanel(system);
        userProcessContainer.add("DonorStatusJPanel", p);
        CardLayout card = (CardLayout) userProcessContainer.getLayout();
        card.next(userProcessContainer);
    }//GEN-LAST:event_check_donor_status

    //monitor all the requests
    private void monitor_request(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_monitor_request
        // TODO add your handling code here:
        Volunteer_Donor_Request_JPanel p = new Volunteer_Donor_Request_JPanel(system);
        userProcessContainer.add("VolunteerDonorRequestJPanel", p);
        CardLayout card = (CardLayout) userProcessContainer.getLayout();
        card.next(userProcessContainer);
    }//GEN-LAST:event_monitor_request
