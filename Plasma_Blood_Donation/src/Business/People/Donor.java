...
// Donor Attributes
    ...
    private boolean labConfirmation; //Was your COVID-19 diagnosis confirmed by a lab test?
    private boolean symptoms;       //Currently you do NOT have any symptoms? 
    private boolean lastDaySymptoms;//Has it been at least 14 days since the last day of your symptoms (COVID-19 symptoms include fever, cough and shortness of breath)? 
    private boolean followUpTest;   //Have you had a follow up test that was negative for COVID-19 or shows you no longer have COVID-19?
