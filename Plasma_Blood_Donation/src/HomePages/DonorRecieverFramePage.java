...
public class DonorRecieverFramePage extends javax.swing.JFrame {
    ...
    private DonorRecieverFramePage() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonorRecieverFramePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DonorRecieverFramePage().setVisible(true);
            }
        });
    }
