 ...
 * @author RST
 */
public class Pathologist_WorkArea_JPanel extends javax.swing.JPanel {

    //Creates new form Pathologist_WorkArea
    boolean a = true;
    private User_Acc userAccount;
    private Pathologist_Association pathoorganization;
    private Enterprise enterprise;
    private EcoSystem system;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    private Network_Cities network;

    public Pathologist_WorkArea_JPanel(User_Acc account, Pathologist_Association pathoorganization, Enterprise enterprise, EcoSystem business, Network_Cities network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.add(Profile, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 220, 70));

        ManageRequests.setBackground(new java.awt.Color(102, 0, 102));
        ...
        jPanel4.add(ManageRequests, new org.netbeans.lib.awtextra.AbsoluteConstraints(-13, 130, 280, -1));
        ...
        jPanel4.add(BtnManageRequest, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 200, 50));
        ...
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, -1, 50));
        ...
        jPanel4.add(BtnProfile, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 196, 44));
    ...
    //used to manage pathologist profile
    private void button_profile(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_profile
        Manage_Pathologist_Profile patho = new Manage_Pathologist_Profile(userAccount, pathoorganization, enterprise);
        userProcessContainer.add("ManagePathologistProfile", patho);
        CardLayout card = (CardLayout) userProcessContainer.getLayout();
        card.next(userProcessContainer);
    }//GEN-LAST:event_button_profile

    private void manage_request(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manage_request
        Manage_Pathologist_Requests patho_request = new Manage_Pathologist_Requests(system, userAccount, pathoorganization, enterprise, network);
        userProcessContainer.add("ManagePathologistRequests", patho_request);
        CardLayout card = (CardLayout) userProcessContainer.getLayout();
        card.next(userProcessContainer);
