 ...
 * @author RST
 */
public class Manage_Govt_Coordinator_Profile extends javax.swing.JPanel {

    //Creates new form Manage Doctor Profile
     
     private User_Acc userAcc;
     private Enterprise e;
     private Government_Association govt;
    
    public Manage_Govt_Coordinator_Profile(User_Acc userAccount, Government_Association govtOrganization, Enterprise enterprise) {
        initComponents();
    ...
    private void viewFields(){        
        ...
        txtCity.setText(userAcc.getEmployee().getCity());
        txtContact.setText(String.valueOf(userAcc.getEmployee().getMobile()));
        txtDOB.setText(String.valueOf(userAcc.getEmployee().getDob()));
        txtName.setText(userAcc.getEmployee().getName());
        txtSpecialization.setText(userAcc.getEmployee().getSpecialization());
        txtState.setText(userAcc.getEmployee().getState());      
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("SPEACILIZATION:");
    ...
    private void save_button(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_button
        ...
        userAcc.getEmployee().setCity(txtCity.getText());
        userAcc.getEmployee().setMobile((txtContact.getText()));
        userAcc.getEmployee().setDob(new Date(txtDOB.getText()));
        userAcc.getEmployee().setGender((String) comboGender.getSelectedItem());
        userAcc.getEmployee().setAddress(txtAddress.getText());        
        userAcc.getEmployee().setState(txtCity.getText());
        userAcc.getEmployee().setSpecialization(txtSpecialization.getText());               
